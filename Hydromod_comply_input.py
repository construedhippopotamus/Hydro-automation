...
path = raw_input("Program determines hydromod compliance for San Diego County. Copy in path to folder with EPA SWMM 5 Q output text files.\n")
...
EXdata = raw_input("Enter name of existing condition Q out text file, for example PRE_DEV_POC-1_QOUT.TXT : \n")
#EXdata = 'PRE_DEV_POC-1_QOUT.TXT'

#Proposed condition Q out file from EPA SWMM 5
PRdata = raw_input("Enter name of proposed condition Q out text file, for example POST_DEV_POC-1_QOUT.TXT : \n")
